 ...
 *
 * Must stay identical to `OSHES_LISTS` in `src/config/oshes.ts` — the two halves
 ...
 * prefixed and not configurable: the site boundary already separates OSHES from
 ...
 *
 * This file previously defaulted to "OSHES "-prefixed names behind env vars that
