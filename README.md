...
React, TypeScript, and Vite application for OSHE operational forms, SharePoint-backed submissions, approval/evaluation workflows, and form administration.
...
- OSHE-specific branding, access language, PDPA wording, environment variables, and groups.
...
For local work: copy `.env.example` to `.env.local` and replace every placeholder with the OSHE tenant, Entra application, SharePoint site, group, email, and deployment values.
